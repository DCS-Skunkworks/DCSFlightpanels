...
namespace DCSFlightpanels
{
    ...
    /// </summary>
    public partial class RadioPanelPZ69UserControlF5E : ISaitekPanelListener, IProfileHandlerListener, ISaitekUserControl
    {
        private readonly RadioPanelPZ69F5E _radioPanelPZ69;
        ...
        private void SetGraphicsState(HashSet<object> knobs)
        {
            try
            {
                ...
                {
                    var radioKnob = (RadioPanelKnobF5E)radioKnobO;
        ...
        /*
        private void SetGroupboxVisibility(RadioPanelPZ69KnobsF5E panelPZ69KnobsF5E)
        {
            try
            {
                GroupLowerSelectorKnobUHF.Visibility = panelPZ69KnobsF5E == RadioPanelPZ69KnobsF5E.UPPER_UHF ? Visibility.Visible : Visibility.Hidden;
                GroupLowerSelectorKnobVHFFM.Visibility = panelPZ69KnobsF5E == RadioPanelPZ69KnobsF5E.UPPER_VHFFM ? Visibility.Visible : Visibility.Hidden;
                GroupLowerSelectorKnobVHFAM.Visibility = panelPZ69KnobsF5E == RadioPanelPZ69KnobsF5E.UPPER_VHFAM ? Visibility.Visible : Visibility.Hidden;
                GroupLowerSelectorKnobTACAN.Visibility = panelPZ69KnobsF5E == RadioPanelPZ69KnobsF5E.UPPER_TACAN ? Visibility.Visible : Visibility.Hidden;
                GroupLowerSelectorKnobILS.Visibility = panelPZ69KnobsF5E == RadioPanelPZ69KnobsF5E.UPPER_ILS ? Visibility.Visible : Visibility.Hidden;
            }
            catch (Exception ex)
            {
        ...
        */
        ...
        private void RadioPanelPZ69UserControlF5E_OnLoaded(object sender, RoutedEventArgs e)
        {
            try
            {
