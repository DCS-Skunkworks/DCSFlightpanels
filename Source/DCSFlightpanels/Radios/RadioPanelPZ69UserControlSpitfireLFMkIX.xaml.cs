...
namespace DCSFlightpanels.Radios
{
    ...
    /// </summary>
    public partial class RadioPanelPZ69UserControlSpitfireLFMkIX : ISaitekPanelListener, IProfileHandlerListener, ISaitekUserControl
    {
        ...
        private void SetGraphicsState(HashSet<object> knobs)
        {
            try
            {
                ...
                {
                    var radioKnob = (RadioPanelKnobSpitfireLFMkIX)radioKnobO;
