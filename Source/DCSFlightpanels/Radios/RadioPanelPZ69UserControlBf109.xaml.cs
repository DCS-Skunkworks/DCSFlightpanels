...
namespace DCSFlightpanels.Radios
{
    ...
    /// </summary>
    public partial class RadioPanelPZ69UserControlBf109 : UserControlBase, IGamingPanelListener, IProfileHandlerListener, IGamingPanelUserControl
    {
        ...
        private void SetGraphicsState(HashSet<object> knobs)
        {
            try
            {
                ...
                {
                    var radioKnob = (RadioPanelKnobBf109)radioKnobO;
        ...
        private void RadioPanelPZ69UserControlBf109_OnLoaded(object sender, RoutedEventArgs e)
        {
            try
            {
