namespace DCSFlightpanels.Radios.PreProgrammed
{
    ...
    /// </summary>
    public partial class RadioPanelPZ69UserControlF86F : UserControlBase, IGamingPanelListener, IProfileHandlerListener, IGamingPanelUserControl
    {
        private readonly RadioPanelPZ69F86F _radioPanelPZ69;

        public RadioPanelPZ69UserControlF86F(HIDSkeleton hidSkeleton, TabItem parentTabItem, IGlobalHandler globalHandler)
        {
            InitializeComponent();
            ...
            HideAllImages();
            _radioPanelPZ69 = new RadioPanelPZ69F86F(hidSkeleton);
        ...
        private void SetGraphicsState(HashSet<object> knobs)
        {
            try
            {
                ...
                {
                    var radioKnob = (RadioPanelKnobF86F)radioKnobO;
