namespace DCSFlightpanels.Radios.PreProgrammed
{
    ...
    /// <summary>
    /// Interaction logic for RadioPanelPZ69UserControlMosquito.xaml
    /// </summary>
    public partial class RadioPanelPZ69UserControlMosquito : IGamingPanelListener, IProfileHandlerListener, IGamingPanelUserControl
    {
        private readonly RadioPanelPZ69Mosquito _radioPanelPZ69;

        public RadioPanelPZ69UserControlMosquito(HIDSkeleton hidSkeleton)
        {
            InitializeComponent();
            
            HideAllImages();
            _radioPanelPZ69 = new RadioPanelPZ69Mosquito(hidSkeleton)
            {
        ...
        private void SetGraphicsState(HashSet<object> knobs)
        {
            try
            {
                ...
                {
                    var radioKnob = (RadioPanelKnobMosquito)radioKnobO;
        ...
        private void RadioPanelPZ69UserControlMosquito_OnLoaded(object sender, RoutedEventArgs e)
        {
