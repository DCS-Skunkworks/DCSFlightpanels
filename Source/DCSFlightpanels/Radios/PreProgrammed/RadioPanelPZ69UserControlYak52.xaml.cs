namespace DCSFlightpanels.Radios.PreProgrammed
{
    ...
    /// <summary>
    /// Interaction logic for RadioPanelPZ69UserControlYak52.xaml
    /// </summary>
    public partial class RadioPanelPZ69UserControlYak52 : IGamingPanelListener, IProfileHandlerListener, IGamingPanelUserControl
    {
        private readonly RadioPanelPZ69Yak52 _radioPanelPZ69;

        public RadioPanelPZ69UserControlYak52(HIDSkeleton hidSkeleton)
        {
            InitializeComponent();

            HideAllImages();
            _radioPanelPZ69 = new RadioPanelPZ69Yak52(hidSkeleton)
            {
        ...
        private void SetGraphicsState(HashSet<object> knobs)
        {
            try
            {
                ...
                {
                    var radioKnob = (RadioPanelKnobYak52)radioKnobO;
        ...
        private void RadioPanelPZ69UserControlYak52_OnLoaded(object sender, RoutedEventArgs e)
        {
