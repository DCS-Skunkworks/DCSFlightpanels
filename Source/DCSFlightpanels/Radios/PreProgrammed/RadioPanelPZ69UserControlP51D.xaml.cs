...
{
    /// <summary>
    /// Interaction logic for RadioPanelPZ69UserControlP51D.xaml
    /// </summary>
    public partial class RadioPanelPZ69UserControlP51D : UserControlBase, IGamingPanelListener, IProfileHandlerListener, IGamingPanelUserControl
    {
        private readonly RadioPanelPZ69P51D _radioPanelPZ69;

        public RadioPanelPZ69UserControlP51D(HIDSkeleton hidSkeleton, TabItem parentTabItem, IGlobalHandler globalHandler)
        {
            InitializeComponent();
            ...
            HideAllImages();
            _radioPanelPZ69 = new RadioPanelPZ69P51D(hidSkeleton);
        ...
        private void SetGraphicsState(HashSet<object> knobs)
        {
            try
            {
                ...
                {
                    var radioKnob = (RadioPanelKnobP51D)radioKnobO;
        ...
        private void RadioPanelPZ69UserControlP51D_OnLoaded(object sender, RoutedEventArgs e)
        {
            try
            {
