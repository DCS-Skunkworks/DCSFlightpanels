namespace DCSFlightpanels.Radios.PreProgrammed
{
    ...
    /// <summary>
    /// Interaction logic for RadioPanelPZ69UserControlFw190.xaml
    /// </summary>
    public partial class RadioPanelPZ69UserControlFw190 : UserControlBase, IGamingPanelListener, IProfileHandlerListener, IGamingPanelUserControl
    {
        private readonly RadioPanelPZ69Fw190 _radioPanelPZ69;

        public RadioPanelPZ69UserControlFw190(HIDSkeleton hidSkeleton, TabItem parentTabItem, IGlobalHandler globalHandler)
        {
            InitializeComponent();
            ...
            HideAllImages();
            _radioPanelPZ69 = new RadioPanelPZ69Fw190(hidSkeleton);
        ...
        private void SetGraphicsState(HashSet<object> knobs)
        {
            try
            {
                ...
                {
                    var radioKnob = (RadioPanelKnobFw190)radioKnobO;
        ...
        private void RadioPanelPZ69UserControlFw190_OnLoaded(object sender, RoutedEventArgs e)
        {
            try
            {
