namespace DCSFlightpanels.Radios.PreProgrammed
{
    ...
    /// <summary>
    /// Interaction logic for RadioPanelPZ69UserControlF16C.xaml
    /// </summary>
    public partial class RadioPanelPZ69UserControlF16C : IGamingPanelListener, IProfileHandlerListener, IGamingPanelUserControl
    {
        private readonly RadioPanelPZ69F16C _radioPanelPZ69;

        public RadioPanelPZ69UserControlF16C(HIDSkeleton hidSkeleton)
        {
            InitializeComponent();
            
            HideAllImages();
            _radioPanelPZ69 = new RadioPanelPZ69F16C(hidSkeleton)
            {
        ...
        private void SetGraphicsState(HashSet<object> knobs)
        {
            try
            {
                ...
                {
                    var radioKnob = (RadioPanelKnobF16C)radioKnobO;
