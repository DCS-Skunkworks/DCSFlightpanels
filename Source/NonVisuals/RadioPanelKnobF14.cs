...
{
    public enum RadioPanelPZ69KnobsF14
    {
        UPPER_VHFAM = 0,
        UPPER_UHF = 2,
        UPPER_VHFFM = 4,
    ...
    public class RadioPanelKnobF14
    {
        public RadioPanelKnobF14(int group, int mask, bool isOn, RadioPanelPZ69KnobsF14 radioPanelPZ69Knob)
        {
            Group = group;
            Mask = mask;
            IsOn = isOn;
        ...
        public RadioPanelPZ69KnobsF14 RadioPanelPZ69Knob { get; set; }
        ...
        public void ImportString(string str)
        {
            ...
            //SWITCHKEY_MASTER_ALT
            RadioPanelPZ69Knob = (RadioPanelPZ69KnobsF14)Enum.Parse(typeof(RadioPanelPZ69KnobsA10C), dataString.Trim());
        }

        public static HashSet<RadioPanelKnobA10C> GetRadioPanelKnobs()
        {
            //true means clockwise turn
            var result = new HashSet<RadioPanelKnobA10C>();
            //Group 0
