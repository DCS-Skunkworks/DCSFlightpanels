    ...
    public class RadioPanelPZ69SpitfireLFMkIX : RadioPanelPZ69Base, IRadioPanel, IDCSBIOSStringListener
    {
        ...
        */
        ...
        public override void DcsBiosDataReceived(uint address, uint data)
        {
            try
            {
                //Common.DebugP("PZ69 SpitfireLFMkIX READ ENTERING");
                ...
                //Common.DebugP("PZ69 SpitfireLFMkIX READ EXITING");
            }
            catch (Exception ex)
            {
        ...
        private void ShowFrequenciesOnPanel()
        {
            try
            {
                lock (_lockShowFrequenciesOnPanelObject)
                {
                    ...
                    {
                        //Common.DebugP("Leaving Spitfire LF Mk. IX Radio ShowFrequenciesOnPanel() NO KNOBS/FREQS changed");
                        return;
                    }
