    ...
    public class DCSBIOSActionBindingPZ70 : DCSBIOSActionBindingBase
    {
        ...
        public override string ExportSettings()
        {
            ...
            if (!string.IsNullOrWhiteSpace(Description))
            {
                ...
                return "MultiPanelDCSBIOSControl{" + Enum.GetName(typeof(PZ70DialPosition), _pz70DialPosition) + "}" + SaitekConstants.SEPARATOR_SYMBOL + "{" + onStr + Enum.GetName(typeof(MultiPanelPZ70Knobs), MultiPanelPZ70Knob) + "|" + Description + "}" + SaitekConstants.SEPARATOR_SYMBOL + stringBuilder;
            }

            return "MultiPanelDCSBIOSControl{" + Enum.GetName(typeof(PZ70DialPosition), _pz70DialPosition) + "}" + SaitekConstants.SEPARATOR_SYMBOL + "{" + onStr + Enum.GetName(typeof(MultiPanelPZ70Knobs), MultiPanelPZ70Knob) + "}" + SaitekConstants.SEPARATOR_SYMBOL + stringBuilder;
        }
