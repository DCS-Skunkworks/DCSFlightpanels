namespace NonVisuals.DCSBIOSBindings
{
    ...
    public class DCSBIOSActionBindingPZ55 : DCSBIOSActionBindingBase
    {
        ...
        public override string ExportSettings()
        {
            ...
            {
                return "SwitchPanelDCSBIOSControl{" + onStr + Enum.GetName(typeof(SwitchPanelPZ55Keys), SwitchPanelPZ55Key) + "|" + Description + "}" + SaitekConstants.SEPARATOR_SYMBOL + stringBuilder;
            }

            return "SwitchPanelDCSBIOSControl{" + onStr + Enum.GetName(typeof(SwitchPanelPZ55Keys), SwitchPanelPZ55Key) + "}" + SaitekConstants.SEPARATOR_SYMBOL + stringBuilder;
        }
