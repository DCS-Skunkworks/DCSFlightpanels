...
namespace NonVisuals.DCSBIOSBindings
{
    ...
    public class DCSBIOSActionBindingFarmingPanel : DCSBIOSActionBindingBase
    {
        ...
        public override string ExportSettings()
        {
            ...
            {
                return "FarmingPanelDCSBIOSControl{" + onStr + Enum.GetName(typeof(FarmingPanelMKKeys), FarmingPanelKey) + "|" + Description + "}" + SaitekConstants.SEPARATOR_SYMBOL + stringBuilder.ToString();
            }
            return "FarmingPanelDCSBIOSControl{" + onStr + Enum.GetName(typeof(FarmingPanelMKKeys), FarmingPanelKey) + "}" + SaitekConstants.SEPARATOR_SYMBOL + stringBuilder.ToString();
        }
