...
namespace NonVisuals.DCSBIOSBindings
{
    public class DCSBIOSActionBindingTPM : DCSBIOSActionBindingBase
    {
        ...
        public override string ExportSettings()
        {
            ...
            {
                return "TPMPanelDCSBIOSControl{" + onStr + Enum.GetName(typeof(TPMPanelSwitches), TPMSwitch) + "|" + Description + "}" + SaitekConstants.SEPARATOR_SYMBOL + stringBuilder.ToString();
            }
            return "TPMPanelDCSBIOSControl{" + onStr + Enum.GetName(typeof(TPMPanelSwitches), TPMSwitch) + "}" + SaitekConstants.SEPARATOR_SYMBOL + stringBuilder.ToString();
        }
