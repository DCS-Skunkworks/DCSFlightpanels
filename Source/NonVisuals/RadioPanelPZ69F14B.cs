        ...
        private string GetVUHFCockpitFrequencyAsString()
        {
            ...
            lock (_lockVuhfBigFreqObject1)
            {
                lock (_lockVuhfDial3FreqObject2)
                {
                    ...
                    {
                        Console.WriteLine("GetVUHFCockpitFrequencyAsString() BIG : " + _vuhfCockpitBigFrequency);
                        Console.WriteLine("GetVUHFCockpitFrequencyAsString() DIAL 3 : " + _vuhfCockpitDial3Frequency);
                        Console.WriteLine("GetVUHFCockpitFrequencyAsString() DIAL 4 : " + _vuhfCockpitDial4Frequency);
            ...
            lock (_lockVuhfBigFreqObject1)
            {
                lock (_lockVuhfDial3FreqObject2)
                {
                    lock (_lockVuhfDial4FreqObject2)
                    {
                        ...
                        Console.WriteLine("SAVED _vuhfSavedCockpitBigFrequency = " + _vuhfSavedCockpitBigFrequency);
                        Console.WriteLine("SAVED _vuhfSavedCockpitDial3Frequency = " + _vuhfSavedCockpitDial3Frequency);
                        Console.WriteLine("SAVED _vuhfSavedCockpitDial4Frequency = " + _vuhfSavedCockpitDial4Frequency);
                    }
                }
            }
        }
        ...
        private void SwapCockpitStandbyFrequencyVuhf()
        {
            lock (_lockVuhfBigFreqObject1)
            {
                lock (_lockVuhfDial3FreqObject2)
                {
                    lock (_lockVuhfDial4FreqObject2)
                    {
                        Console.WriteLine("SWAPPING _vuhfSavedCockpitBigFrequency = " + _vuhfSavedCockpitBigFrequency);
                        Console.WriteLine("SWAPPING _vuhfSavedCockpitDial3Frequency = " + _vuhfSavedCockpitDial3Frequency);
                        Console.WriteLine("SWAPPING _vuhfSavedCockpitDial4Frequency = " + _vuhfSavedCockpitDial4Frequency);
