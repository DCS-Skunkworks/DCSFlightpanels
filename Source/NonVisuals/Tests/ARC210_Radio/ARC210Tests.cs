...
namespace NonVisuals.Tests.ARC210_Radio
{
    public class ARC210Tests
    {
        ...
        [Theory]
        [InlineData("30.000",  ARC210FrequencyBand.FM, new[] { ARC210FrequencyBand.FM })]
        [InlineData("108.000",  ARC210FrequencyBand.VHF1, new[] { ARC210FrequencyBand.VHF1 })]
        [InlineData("118.000",  ARC210FrequencyBand.VHF2, new[] { ARC210FrequencyBand.VHF2 })]
        [InlineData("225.000",  ARC210FrequencyBand.UHF, new[] { ARC210FrequencyBand.UHF })]
        internal void ARC210_Initial_Standby_Frequency_Equals(string frequency, ARC210FrequencyBand initialFrequencyBand, ARC210FrequencyBand[] supportedFrequencyBands)
        {
        ...
        /* UHF AM 225.000 to 399.975 MHz */
        [Theory]
        [InlineData("35.000",  ARC210FrequencyBand.FM, new[] { ARC210FrequencyBand.FM })]
        [InlineData("113.000",  ARC210FrequencyBand.VHF1, new[] { ARC210FrequencyBand.VHF1 })]
        [InlineData("123.000",  ARC210FrequencyBand.VHF2, new[] { ARC210FrequencyBand.VHF2 })]
        [InlineData("230.000",  ARC210FrequencyBand.UHF, new[] { ARC210FrequencyBand.UHF })]
        internal void ARC210_Big_Frequency_Up_Equals(string newFrequency, ARC210FrequencyBand initialFrequencyBand, ARC210FrequencyBand[] supportedFrequencyBands)
        {
            var arc210 = new ARC210("ARC_210_RADIO", initialFrequencyBand, supportedFrequencyBands);
            arc210.InitRadio();
        ...
        /* UHF AM 225.000 to 399.975 MHz */
        [Theory]
        [InlineData("83.000",  ARC210FrequencyBand.FM, new[] { ARC210FrequencyBand.FM })]
        [InlineData("111.000",  ARC210FrequencyBand.VHF1, new[] { ARC210FrequencyBand.VHF1 })]
        [InlineData("169.000",  ARC210FrequencyBand.VHF2, new[] { ARC210FrequencyBand.VHF2 })]
        [InlineData("395.000",  ARC210FrequencyBand.UHF, new[] { ARC210FrequencyBand.UHF })]
        internal void ARC210_Big_Frequency_Down_Equals(string newFrequency, ARC210FrequencyBand initialFrequencyBand, ARC210FrequencyBand[] supportedFrequencyBands)
        {
            var arc210 = new ARC210("ARC_210_RADIO", initialFrequencyBand, supportedFrequencyBands);
            arc210.InitRadio();
        ...
        /* UHF AM 225.000 to 399.975 MHz */
        [Theory]
        [InlineData("30.075",  ARC210FrequencyBand.FM, new[] { ARC210FrequencyBand.FM })]
        [InlineData("108.075",  ARC210FrequencyBand.VHF1, new[] { ARC210FrequencyBand.VHF1 })]
        [InlineData("118.075",  ARC210FrequencyBand.VHF2, new[] { ARC210FrequencyBand.VHF2 })]
        [InlineData("225.075",  ARC210FrequencyBand.UHF, new[] { ARC210FrequencyBand.UHF })]
        internal void ARC210_Small_Frequency_Up_Equals(string newFrequency, ARC210FrequencyBand initialFrequencyBand, ARC210FrequencyBand[] supportedFrequencyBands)
        {
            var arc210 = new ARC210("ARC_210_RADIO", initialFrequencyBand, supportedFrequencyBands);
            arc210.InitRadio();
        ...
        /* UHF AM 225.000 to 399.975 MHz */
        [Theory]
        [InlineData("30.925",  ARC210FrequencyBand.FM, new[] { ARC210FrequencyBand.FM })]
        [InlineData("108.925",  ARC210FrequencyBand.VHF1, new[] { ARC210FrequencyBand.VHF1 })]
        [InlineData("118.925",  ARC210FrequencyBand.VHF2, new[] { ARC210FrequencyBand.VHF2 })]
        [InlineData("225.925",  ARC210FrequencyBand.UHF, new[] { ARC210FrequencyBand.UHF })]
        internal void ARC210_Small_Frequency_Down_Equals(string newFrequency, ARC210FrequencyBand initialFrequencyBand, ARC210FrequencyBand[] supportedFrequencyBands)
        {
            var arc210 = new ARC210("ARC_210_RADIO", initialFrequencyBand, supportedFrequencyBands);
            arc210.InitRadio();
        ...
        [InlineData(ARC210FrequencyBand.UHF, ARC210FrequencyBand.UHF, new[] { ARC210FrequencyBand.VHF2, ARC210FrequencyBand.UHF, ARC210FrequencyBand.VHF1, ARC210FrequencyBand.VHF2, ARC210FrequencyBand.UHF, ARC210FrequencyBand.VHF1 })]
        ...
        [InlineData("30.000", "ARC_210_RADIO", ARC210FrequencyBand.UHF, new[] { ARC210FrequencyBand.FM, ARC210FrequencyBand.VHF2, ARC210FrequencyBand.UHF })]
        [InlineData("225.000", "ARC_210_RADIO", ARC210FrequencyBand.VHF2, new[] { ARC210FrequencyBand.FM, ARC210FrequencyBand.VHF2, ARC210FrequencyBand.UHF })]
        internal void ARC210_Switch_Frequency_Band_Up_Equals(string newFrequency, string dcsbiosIdentifier, ARC210FrequencyBand initialFrequencyBand, ARC210FrequencyBand[] supportedFrequencyBands)
        {
        ...
        /* UHF AM 225.000 to 399.975 MHz */
        [Theory]
        [InlineData("108.000",  ARC210FrequencyBand.FM, new[] { ARC210FrequencyBand.FM, ARC210FrequencyBand.VHF1 })]
        [InlineData("118.000",  ARC210FrequencyBand.VHF1, new[] { ARC210FrequencyBand.VHF1, ARC210FrequencyBand.VHF2 })]
        [InlineData("225.000",  ARC210FrequencyBand.VHF2, new[] { ARC210FrequencyBand.VHF2, ARC210FrequencyBand.UHF })]
        [InlineData("30.000",  ARC210FrequencyBand.UHF, new[] { ARC210FrequencyBand.FM, ARC210FrequencyBand.UHF })]

        [InlineData("225.000",  ARC210FrequencyBand.FM, new[] { ARC210FrequencyBand.FM, ARC210FrequencyBand.UHF })]
        [InlineData("30.000",  ARC210FrequencyBand.VHF1, new[] { ARC210FrequencyBand.VHF1, ARC210FrequencyBand.FM })]
        [InlineData("108.000",  ARC210FrequencyBand.VHF2, new[] { ARC210FrequencyBand.VHF1, ARC210FrequencyBand.VHF2 })]
        [InlineData("118.000",  ARC210FrequencyBand.UHF, new[] { ARC210FrequencyBand.VHF2, ARC210FrequencyBand.UHF })]
        [InlineData("118.000",  ARC210FrequencyBand.UHF, new[] { ARC210FrequencyBand.FM, ARC210FrequencyBand.VHF2, ARC210FrequencyBand.UHF })]
        [InlineData("30.000",  ARC210FrequencyBand.VHF2, new[] { ARC210FrequencyBand.FM, ARC210FrequencyBand.VHF2, ARC210FrequencyBand.UHF })]
        internal void ARC210_Switch_Frequency_Band_Down_Equals(string newFrequency, ARC210FrequencyBand initialFrequencyBand, ARC210FrequencyBand[] supportedFrequencyBands)
        {
