...
namespace NonVisuals
{
    public class RadioPanelPZ69F5E : RadioPanelPZ69Base, IDCSBIOSStringListener, IRadioPanel
    {
        ...
        private CurrentF5ERadioMode _currentUpperRadioMode = CurrentF5ERadioMode.COMM1;
        private CurrentF5ERadioMode _currentLowerRadioMode = CurrentF5ERadioMode.COMM2;
        ...
        private void SendFrequencyToDCSBIOS(RadioPanelPZ69KnobsF5E knob)   // Send changes to DCSbios when press the UPPER_FREQ_SWITCH or LOWER_FREQ_SWITCH
        {
                ...
                case RadioPanelPZ69KnobsF5E.UPPER_FREQ_SWITCH:
                    {
                        ...
                        {
                            case CurrentF5ERadioMode.COMM1:
                                {

                                    break;
                                }
                            case CurrentF5ERadioMode.COMM2:
                                {
                                  
                                    break;
                                }
                            case CurrentF5ERadioMode.VHFFM:
                                {
                                   
                                    break;
                                }
                            case CurrentF5ERadioMode.ILS:
                                {
                                    SendILSToDCSBIOS();
                                    break;
                                }
        ...
        private void ShowFrequenciesOnPanel()
        {
            lock (_lockShowFrequenciesOnPanelObject)
            {
                ...
                switch (_currentUpperRadioMode)
                {
                    case CurrentF5ERadioMode.COMM1:    // show comm1 frequencies in upper panel
                        {
                    ...
                    case CurrentF5ERadioMode.COMM2:     //  show comm2 frequencies in upper panel
                        {
                            var frequencyAsString = "";
                    ...
                    case CurrentF5ERadioMode.VHFFM:  // clear displays
                        {
                    ...
                    case CurrentF5ERadioMode.TACAN:  // clear displays
                        {
                            if (_upperButtonPressed)
                            {
                ...
                switch (_currentLowerRadioMode)
                {
                    ...
                    case CurrentF5ERadioMode.COMM1:     //  show comm1 frequencies in lower panel
                        {
                            var frequencyAsString = "";
                    ...
                    case CurrentF5ERadioMode.COMM2:     //  show comm2 frequencies in lower panel
                        {
                            var frequencyAsString = "";
                            uint integer_comm2 = _comm2CockpitFreq / 100;
                            uint decimal_comm2 = _comm2CockpitFreq - (integer_comm2 * 100);
        ...
        public void PZ69KnobChanged(IEnumerable<object> hashSet)
        {
            lock (LockLCDUpdateObject)
            {
                ...
                foreach (var radioPanelKnobObject in hashSet)
                {
                    ...
                    {
                        case RadioPanelPZ69KnobsF5E.UPPER_COMM1:
                            {
                                if (radioPanelKnob.IsOn)
                                {
                                    _currentUpperRadioMode = CurrentF5ERadioMode.COMM1;
                                }
                                break;
                            }
                        case RadioPanelPZ69KnobsF5E.UPPER_COMM2:
                            {
                                if (radioPanelKnob.IsOn)
                                {
                                    _currentUpperRadioMode = CurrentF5ERadioMode.COMM2;
                                }
                                break;
                            }
                        case RadioPanelPZ69KnobsF5E.UPPER_VHFFM:
                            {
                                if (radioPanelKnob.IsOn)
                                {
                                    _currentUpperRadioMode = CurrentF5ERadioMode.VHFFM;
                                }
                                break;
                            }
                        case RadioPanelPZ69KnobsF5E.UPPER_ILS:
                            {
                                if (radioPanelKnob.IsOn)
                                {
                                    _currentUpperRadioMode = CurrentF5ERadioMode.ILS;
                                }
                                break;
                            }
                        ...
                        case RadioPanelPZ69KnobsF5E.UPPER_DME:
                            {
                                break;
                            }
                        case RadioPanelPZ69KnobsF5E.UPPER_XPDR:
                            {
                                break;
                            }
                        case RadioPanelPZ69KnobsF5E.LOWER_COMM1:
                            {
                                if (radioPanelKnob.IsOn)
                                {
                                    _currentLowerRadioMode = CurrentF5ERadioMode.COMM1;
                                }
                                break;
                            }
                        case RadioPanelPZ69KnobsF5E.LOWER_COMM2:
                            {
                                if (radioPanelKnob.IsOn)
                                {
                                    _currentLowerRadioMode = CurrentF5ERadioMode.COMM2;
                                }
                                break;
                            }
                        case RadioPanelPZ69KnobsF5E.LOWER_VHFFM:
                            {

                                if (radioPanelKnob.IsOn)
                                {
                                    _currentLowerRadioMode = CurrentF5ERadioMode.VHFFM;
                                }
                                break;
                            }
                        case RadioPanelPZ69KnobsF5E.LOWER_ILS:
                            {
                                if (radioPanelKnob.IsOn)
                                {
                                    _currentLowerRadioMode = CurrentF5ERadioMode.ILS;
                                }
                                break;
                            }
                        ...
                        case RadioPanelPZ69KnobsF5E.LOWER_DME:
                            {
                                break;
                            }
                        case RadioPanelPZ69KnobsF5E.LOWER_XPDR:
                            {
                                break;
                            }
                        case RadioPanelPZ69KnobsF5E.UPPER_LARGE_FREQ_WHEEL_INC:
                        ...
                        case RadioPanelPZ69KnobsF5E.UPPER_FREQ_SWITCH:
                            {
                                ...
                                if (_currentUpperRadioMode == CurrentF5ERadioMode.COMM1)
                                {
                                    DCSBIOS.Send(_upperButtonPressed ? COMM1PullPress : COMM1PullRelease);
                                }
                                if (_currentUpperRadioMode == CurrentF5ERadioMode.COMM2)
                                {
                        ...
                        case RadioPanelPZ69KnobsF5E.LOWER_FREQ_SWITCH:
                            {
                                ...
                                if (_currentLowerRadioMode == CurrentF5ERadioMode.COMM1)
                                {
                                    DCSBIOS.Send(_lowerButtonPressed ? COMM1PullPress : COMM1PullRelease);
                                }
                                if (_currentLowerRadioMode == CurrentF5ERadioMode.COMM2)
                                {
