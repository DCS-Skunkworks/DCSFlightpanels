    ...
    public class RadioPanelPZ69AH64D : RadioPanelPZ69Base, IDCSBIOSStringListener
    {
        ...
        private string GetStandbyFrequencyString(CurrentAH64DRadioMode radio)
        {
            return radio switch
            {
                ...
                CurrentAH64DRadioMode.HF => _hfBigFrequencyStandby + "." + _hfSmallFrequencyStandby.ToString().PadLeft(3, '0').PadRight(3,'0'), // to not get float rounding errors
                        ...
                        case RadioPanelPZ69KnobsAH64D.UPPER_LARGE_FREQ_WHEEL_INC:
                            {
                                switch (_currentUpperRadioMode)
                                {
                                    case CurrentAH64DRadioMode.FM1:
                                        {
                                            /* 30.000 - 87.975 MHz */
                                            if (_fm1BigFrequencyStandby.Equals(87))
                                            {
                                                // @ max value
                                                break;
                                            }
                                    ...
                                    case CurrentAH64DRadioMode.FM2:
                                        {
                                            /* 30.000 - 87.975 MHz */
                                            if (_fm2BigFrequencyStandby.Equals(87))
                                            {
                                                // @ max value
                                                break;
                                            }
                                    ...
                                    case CurrentAH64DRadioMode.HF:
                                        {
                                            /* 2.0000 - 29.9999 MHz */
                                            if (_hfBigFrequencyStandby.Equals(29))
                                            {
                                                // @ max value
                                                break;
                                            }
                                    ...
                                    case CurrentAH64DRadioMode.VHF:
                                        {
                                            /* 108.000 - 151.975 MHz */
                                            if (_vhfBigFrequencyStandby.Equals(151))
                                            {
                                                // @ max value
                                                break;
                                            }
                        ...
                        case RadioPanelPZ69KnobsAH64D.UPPER_LARGE_FREQ_WHEEL_DEC:
                            {
                                switch (_currentUpperRadioMode)
                                {
                                    case CurrentAH64DRadioMode.FM1:
                                        {
                                            /* 30.000 - 87.975 MHz */
                                            if (_fm1BigFrequencyStandby.Equals(30))
                                            {
                                                // @ min value
                                                break;
                                            }
                                    ...
                                    case CurrentAH64DRadioMode.FM2:
                                        {
                                            /* 30.000 - 87.975 MHz */
                                            if (_fm2BigFrequencyStandby.Equals(30))
                                            {
                                                // @ min value
                                                break;
                                            }
                                    ...
                                    case CurrentAH64DRadioMode.HF:
                                        {
                                            /* 2.0000 - 29.9999 MHz */
                                            if (_hfBigFrequencyStandby.Equals(2))
                                            {
                                                // @ min value
                                                break;
                                            }
                                    ...
                                    case CurrentAH64DRadioMode.VHF:
                                        {
                                            /* 108.000 - 151.975 MHz */
                                            if (_vhfBigFrequencyStandby.Equals(108))
                                            {
                                                // @ min value
                                                break;
                                            }
                        ...
                        case RadioPanelPZ69KnobsAH64D.UPPER_SMALL_FREQ_WHEEL_INC:
                            {
                                switch (_currentUpperRadioMode)
                                {
                                    case CurrentAH64DRadioMode.FM1:
                                        {
                                            /* 30.000 - 87.975 MHz */
                                            if (_fm1SmallFrequencyStandby.Equals(975))
                                            {
                                                // @ max value
                                                break;
                                            }
                                    ...
                                    case CurrentAH64DRadioMode.FM2:
                                        {
                                            /* 30.000 - 87.975 MHz */
                                            if (_fm2SmallFrequencyStandby.Equals(975))
                                            {
                                                // @ max value
                                                break;
                                            }
                                    ...
                                    case CurrentAH64DRadioMode.HF:
                                        {
                                            /* 2.0000 - 29.9999 MHz */
                                            if (_hfSmallFrequencyStandby.Equals(9999))
                                            {
                                                // @ max value
                                                break;
                                            }
                                            _hfSmallFrequencyStandby += 1;
                                            break;
                                        }
                                    case CurrentAH64DRadioMode.UHF:
                                        {
                                            /* 225.000 - 399.975 MHz */
                                            if (_uhfSmallFrequencyStandby.Equals(975))
                                            {
                                                // @ max value
                                                break;
                                            }
                                    ...
                                    case CurrentAH64DRadioMode.VHF:
                                        {
                                            /* 108.000 - 151.975 MHz */
                                            if (_vhfSmallFrequencyStandby.Equals(975))
                                            {
                                                // @ max value
                                                break;
                                            }
                        ...
                        case RadioPanelPZ69KnobsAH64D.UPPER_SMALL_FREQ_WHEEL_DEC:
                            {
                                switch (_currentUpperRadioMode)
                                {
                                    ...
                                    case CurrentAH64DRadioMode.HF:
                                        {
                                            /* 2.0000 - 29.9999 MHz */
                                            if (_hfSmallFrequencyStandby.Equals(0))
                                            {
                                                // @ max value
                                                break;
                                            }
