...
namespace Tests.NonVisuals
{
    public class RadioPanelPZ69A10CTests
    {
        ...
        [Theory]
        [InlineData(1, 13, RadioPanelPZ69Base.Decrease)]
        [InlineData(13, 0, RadioPanelPZ69Base.Decrease)]
        [InlineData(555, 666, RadioPanelPZ69Base.Decrease)]
        [InlineData(-1, 12, RadioPanelPZ69Base.Decrease)]
        public void GetCommandDirectionForVhfDial1_ThrowsException_For_UnexpectedValues(int desiredDialPosition, uint actualDialPosition, string expectedValue)
        {
