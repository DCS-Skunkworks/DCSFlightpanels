...
namespace NonVisuals.Tests.Radios
{
    public class RadioPanelPZ69A10CTests
    {
        ...
        [InlineData(0, 6, RadioPanelPZ69Base.DCSBIOS_DECREASE_COMMAND)]
        ...
        [InlineData(0, 10, RadioPanelPZ69Base.DCSBIOS_INCREASE_COMMAND)]
        [InlineData(0, 11, RadioPanelPZ69Base.DCSBIOS_INCREASE_COMMAND)]
        [InlineData(0, 12, RadioPanelPZ69Base.DCSBIOS_INCREASE_COMMAND)]
        ...
        [InlineData(1, 7, RadioPanelPZ69Base.DCSBIOS_DECREASE_COMMAND)]
        [InlineData(1, 8, RadioPanelPZ69Base.DCSBIOS_INCREASE_COMMAND)]
        [InlineData(1, 9, RadioPanelPZ69Base.DCSBIOS_INCREASE_COMMAND)]
        [InlineData(1, 10, RadioPanelPZ69Base.DCSBIOS_INCREASE_COMMAND)]
        [InlineData(1, 11, RadioPanelPZ69Base.DCSBIOS_INCREASE_COMMAND)]
        [InlineData(1, 12, RadioPanelPZ69Base.DCSBIOS_INCREASE_COMMAND)]
        ...
        [InlineData(2, 8, RadioPanelPZ69Base.DCSBIOS_DECREASE_COMMAND)]
        [InlineData(2, 9, RadioPanelPZ69Base.DCSBIOS_INCREASE_COMMAND)]
        [InlineData(2, 10, RadioPanelPZ69Base.DCSBIOS_INCREASE_COMMAND)]
        [InlineData(2, 11, RadioPanelPZ69Base.DCSBIOS_INCREASE_COMMAND)]
        [InlineData(2, 12, RadioPanelPZ69Base.DCSBIOS_INCREASE_COMMAND)]
        ...
        [InlineData(3, 9, RadioPanelPZ69Base.DCSBIOS_DECREASE_COMMAND)]
        [InlineData(3, 10, RadioPanelPZ69Base.DCSBIOS_INCREASE_COMMAND)]
        [InlineData(3, 11, RadioPanelPZ69Base.DCSBIOS_INCREASE_COMMAND)]
        [InlineData(3, 12, RadioPanelPZ69Base.DCSBIOS_INCREASE_COMMAND)]
        ...
        [InlineData(4, 10, RadioPanelPZ69Base.DCSBIOS_DECREASE_COMMAND)]
        [InlineData(4, 11, RadioPanelPZ69Base.DCSBIOS_INCREASE_COMMAND)]
        [InlineData(4, 12, RadioPanelPZ69Base.DCSBIOS_INCREASE_COMMAND)]
        ...
        [InlineData(5, 10, RadioPanelPZ69Base.DCSBIOS_DECREASE_COMMAND)]
        [InlineData(5, 11, RadioPanelPZ69Base.DCSBIOS_DECREASE_COMMAND)]
        [InlineData(5, 12, RadioPanelPZ69Base.DCSBIOS_INCREASE_COMMAND)]
        
        [InlineData(6, 0, RadioPanelPZ69Base.DCSBIOS_INCREASE_COMMAND)]
        ...
        [InlineData(6, 10, RadioPanelPZ69Base.DCSBIOS_DECREASE_COMMAND)]
        [InlineData(6, 11, RadioPanelPZ69Base.DCSBIOS_DECREASE_COMMAND)]
        [InlineData(6, 12, RadioPanelPZ69Base.DCSBIOS_DECREASE_COMMAND)]

        [InlineData(7, 0, RadioPanelPZ69Base.DCSBIOS_DECREASE_COMMAND)]
        [InlineData(7, 1, RadioPanelPZ69Base.DCSBIOS_INCREASE_COMMAND)]
        ...
        [InlineData(7, 10, RadioPanelPZ69Base.DCSBIOS_DECREASE_COMMAND)]
        [InlineData(7, 11, RadioPanelPZ69Base.DCSBIOS_DECREASE_COMMAND)]
        [InlineData(7, 12, RadioPanelPZ69Base.DCSBIOS_DECREASE_COMMAND)]

        [InlineData(8, 0, RadioPanelPZ69Base.DCSBIOS_DECREASE_COMMAND)]
        [InlineData(8, 1, RadioPanelPZ69Base.DCSBIOS_DECREASE_COMMAND)]
        [InlineData(8, 2, RadioPanelPZ69Base.DCSBIOS_INCREASE_COMMAND)]
        ...
        [InlineData(8, 10, RadioPanelPZ69Base.DCSBIOS_DECREASE_COMMAND)]
        [InlineData(8, 11, RadioPanelPZ69Base.DCSBIOS_DECREASE_COMMAND)]
        [InlineData(8, 12, RadioPanelPZ69Base.DCSBIOS_DECREASE_COMMAND)]
        ...
        [InlineData(9, 3, RadioPanelPZ69Base.DCSBIOS_INCREASE_COMMAND)]
        ...
        [InlineData(9, 9, null)]
        [InlineData(9, 10, RadioPanelPZ69Base.DCSBIOS_DECREASE_COMMAND)]
        [InlineData(9, 11, RadioPanelPZ69Base.DCSBIOS_DECREASE_COMMAND)]
        [InlineData(9, 12, RadioPanelPZ69Base.DCSBIOS_DECREASE_COMMAND)]

        [InlineData(10, 0, RadioPanelPZ69Base.DCSBIOS_DECREASE_COMMAND)]
        [InlineData(10, 1, RadioPanelPZ69Base.DCSBIOS_DECREASE_COMMAND)]
        [InlineData(10, 2, RadioPanelPZ69Base.DCSBIOS_DECREASE_COMMAND)]
        [InlineData(10, 3, RadioPanelPZ69Base.DCSBIOS_DECREASE_COMMAND)]
        [InlineData(10, 4, RadioPanelPZ69Base.DCSBIOS_INCREASE_COMMAND)]
        [InlineData(10, 5, RadioPanelPZ69Base.DCSBIOS_INCREASE_COMMAND)]
        [InlineData(10, 6, RadioPanelPZ69Base.DCSBIOS_INCREASE_COMMAND)]
        [InlineData(10, 7, RadioPanelPZ69Base.DCSBIOS_INCREASE_COMMAND)]
        [InlineData(10, 8, RadioPanelPZ69Base.DCSBIOS_INCREASE_COMMAND)]
        [InlineData(10, 9, RadioPanelPZ69Base.DCSBIOS_INCREASE_COMMAND)]
        [InlineData(10, 10, null)]
        [InlineData(10, 11, RadioPanelPZ69Base.DCSBIOS_DECREASE_COMMAND)]
        [InlineData(10, 12, RadioPanelPZ69Base.DCSBIOS_DECREASE_COMMAND)]

        [InlineData(11, 0, RadioPanelPZ69Base.DCSBIOS_DECREASE_COMMAND)]
        [InlineData(11, 1, RadioPanelPZ69Base.DCSBIOS_DECREASE_COMMAND)]
        [InlineData(11, 2, RadioPanelPZ69Base.DCSBIOS_DECREASE_COMMAND)]
        [InlineData(11, 3, RadioPanelPZ69Base.DCSBIOS_DECREASE_COMMAND)]
        [InlineData(11, 4, RadioPanelPZ69Base.DCSBIOS_DECREASE_COMMAND)]
        [InlineData(11, 5, RadioPanelPZ69Base.DCSBIOS_INCREASE_COMMAND)]
        [InlineData(11, 6, RadioPanelPZ69Base.DCSBIOS_INCREASE_COMMAND)]
        [InlineData(11, 7, RadioPanelPZ69Base.DCSBIOS_INCREASE_COMMAND)]
        [InlineData(11, 8, RadioPanelPZ69Base.DCSBIOS_INCREASE_COMMAND)]
        [InlineData(11, 9, RadioPanelPZ69Base.DCSBIOS_INCREASE_COMMAND)]
        [InlineData(11, 10, RadioPanelPZ69Base.DCSBIOS_INCREASE_COMMAND)]
        [InlineData(11, 11, null)]
        [InlineData(11, 12, RadioPanelPZ69Base.DCSBIOS_DECREASE_COMMAND)]

        [InlineData(12, 0, RadioPanelPZ69Base.DCSBIOS_DECREASE_COMMAND)]
        [InlineData(12, 1, RadioPanelPZ69Base.DCSBIOS_DECREASE_COMMAND)]
        [InlineData(12, 2, RadioPanelPZ69Base.DCSBIOS_DECREASE_COMMAND)]
        [InlineData(12, 3, RadioPanelPZ69Base.DCSBIOS_DECREASE_COMMAND)]
        [InlineData(12, 4, RadioPanelPZ69Base.DCSBIOS_DECREASE_COMMAND)]
        [InlineData(12, 5, RadioPanelPZ69Base.DCSBIOS_DECREASE_COMMAND)]
        [InlineData(12, 6, RadioPanelPZ69Base.DCSBIOS_INCREASE_COMMAND)]
        [InlineData(12, 7, RadioPanelPZ69Base.DCSBIOS_INCREASE_COMMAND)]
        [InlineData(12, 8, RadioPanelPZ69Base.DCSBIOS_INCREASE_COMMAND)]
        [InlineData(12, 9, RadioPanelPZ69Base.DCSBIOS_INCREASE_COMMAND)]
        [InlineData(12, 10, RadioPanelPZ69Base.DCSBIOS_INCREASE_COMMAND)]
        [InlineData(12, 11, RadioPanelPZ69Base.DCSBIOS_INCREASE_COMMAND)]
