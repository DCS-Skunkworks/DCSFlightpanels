...
namespace NonVisuals.Radios
{
    ...
    public class RadioPanelPZ69A10CII : RadioPanelPZ69Base, IDCSBIOSStringListener
    {
        ...
        private CancellationTokenSource _arc210VhfSyncTaskTokenSource = new();
        ...
        protected override void Dispose(bool disposing)
        {
            ...
            if (!_disposed)
            {
                if (disposing)
                {
                    ...
                    _arc210VhfSyncTaskTokenSource.Cancel();
        ...
        {
            if (_arc210VhfSyncTask?.Status == TaskStatus.Running)
            {
                return;
            }
        ...
        private async Task SyncARC210VhfAsync(int desiredPositionDial1, int desiredPositionDial2, int desiredPositionDial3, int desiredPositionDial4, int desiredPositionDial5, CancellationToken cancellationToken)
        {
            ...
            {   /*
                ...
                do
                {
                    ...
                    {
                        ResetWaitingForFeedBack(ref _arc210VhfDial1WaitingForFeedback); // Let's do an ugly reset
                    }

                    if (IsTimedOut(ref dial2Timeout))
                    {
                        ResetWaitingForFeedBack(ref _arc210VhfDial2WaitingForFeedback); // Let's do an ugly reset
                    }

                    if (IsTimedOut(ref dial3Timeout))
                    {
                        ResetWaitingForFeedBack(ref _arc210VhfDial3WaitingForFeedback); // Let's do an ugly reset
                    }

                    if (IsTimedOut(ref dial4Timeout))
                    {
                        ResetWaitingForFeedBack(ref _arc210VhfDial4WaitingForFeedback); // Let's do an ugly reset
                    }

                    if (IsTimedOut(ref dial5Timeout))
                    {
                        ResetWaitingForFeedBack(ref _arc210VhfDial5WaitingForFeedback); // Let's do an ugly reset
                    }
                    ...
                    if (Interlocked.Read(ref _arc210VhfDial2WaitingForFeedback) == 0)
                    {
                        ...
                        lock (_lockArc210VhfDialsObject2)
                        {
                            if (_arc210VhfCockpitFreq2DialPos != desiredPositionDial2)
                            {
                                ...
                                command = ARC210_VHF_FREQ_2DIAL_COMMAND + GetCommandDirectionForARC210VhfDial23(desiredPositionDial2, _arc210VhfCockpitFreq2DialPos);
                            }
                        }
                    ...
                    if (Interlocked.Read(ref _arc210VhfDial3WaitingForFeedback) == 0)
                    {
                        ...
                        lock (_lockArc210VhfDialsObject3)
                        {
                            if (_arc210VhfCockpitFreq3DialPos != desiredPositionDial3)
                            {
                                ...
                                command = ARC210_VHF_FREQ_3DIAL_COMMAND + GetCommandDirectionForARC210VhfDial23(desiredPositionDial3, _arc210VhfCockpitFreq3DialPos);
                            }
                        }
                    ...
                    if (Interlocked.Read(ref _arc210VhfDial4WaitingForFeedback) == 0)
                    {
                        ...
                        lock (_lockArc210VhfDialsObject4)
                        {
                            if (_arc210VhfCockpitFreq4DialPos != desiredPositionDial4)
                            {
                                ...
                                command = ARC210_VHF_FREQ_4DIAL_COMMAND + GetCommandDirectionForARC210VhfDial23(desiredPositionDial4, _arc210VhfCockpitFreq4DialPos);
                            }
                        }
                    ...
                    if (Interlocked.Read(ref _arc210VhfDial5WaitingForFeedback) == 0)
                    {
                        ...
                        lock (_lockArc210VhfDialsObject5)
                        {
                            if (_arc210VhfCockpitFreq5DialPos < desiredPositionDial5)
                            {
                                ...
                                command = ARC210_VHF_FREQ_5DIAL_COMMAND + DCSBIOS_INCREASE_COMMAND;
                            }
                            else if (_arc210VhfCockpitFreq5DialPos > desiredPositionDial5)
                            {
                                dial5OkTime = DateTime.Now.Ticks;
                                command = ARC210_VHF_FREQ_5DIAL_COMMAND + DCSBIOS_DECREASE_COMMAND;
                            }
                        }
                ...
                do
                {
                    ...
                    if (Interlocked.Read(ref _uhfDial3WaitingForFeedback) == 0)
                    {
                        ...
                        lock (_lockUhfDialsObject3)
                        {
                            ...
                            if (_uhfCockpitFreq3DialPos < desiredPosition3)
                            {
                                command = UHF_FREQ_3DIAL_COMMAND + DCSBIOS_INCREASE_COMMAND;
                            }
                                    ...
                                    case CurrentA10RadioMode.ARC210_VHF:
                                        {
                                            if (_upperButtonPressed)
                                            {
                                                ...
                                                await DCSBIOS.SendAsync(ARC210_VHF_RADIO_MODE_DIAL_INCREASE);
                                            }
                                            else if (ARC210VhfManualSelected())
                                            {
                                    ...
                                    case CurrentA10RadioMode.ARC210_VHF:
                                        {
                                            ...
                                            {
                                                _upperButtonPressedAndDialRotated = true;
                                                await DCSBIOS.SendAsync(ARC210_VHF_RADIO_MODE_DIAL_DECREASE);
                                            }
                                            else if (ARC210VhfManualSelected())
                                            {
                                    ...
                                    case CurrentA10RadioMode.ARC210_VHF:
                                        {
                                            ...
                                            {
                                                _upperButtonPressedAndDialRotated = true;
                                                await DCSBIOS.SendAsync(ARC210_VHF_MODE_DIAL_INCREASE);
                                            }
                                            else if (ARC210VhfPresetSelected() && _arc210VhfChannelDialClickSpeedDetector.ClickAndCheck())
                                            {
                                                await DCSBIOS.SendAsync(ARC210_VHF_CHANNEL_DIAL_INCREASE);
                                            }
                                            else if (ARC210VhfManualSelected())
                                            {
                                    ...
                                    case CurrentA10RadioMode.ARC210_VHF:
                                        {
                                            ...
                                            {
                                                _upperButtonPressedAndDialRotated = true;
                                                await DCSBIOS.SendAsync(ARC210_VHF_MODE_DIAL_DECREASE);
                                            }
                                            else if (ARC210VhfPresetSelected() && _arc210VhfChannelDialClickSpeedDetector.ClickAndCheck())
                                            {
                                                await DCSBIOS.SendAsync(ARC210_VHF_CHANNEL_DIAL_DECREASE);
                                            }
                                            else if (ARC210VhfManualSelected())
                                            {
