        ...
        */
        ...
        private void SendUhfPresetChannelChangeToDCSBIOS()
        {
            try
            {
                ...
                DCSBIOS.SendAsync(_uhfIncreasePresetChannel ? UHF_PRESET_DIAL_COMMAND_INC : UHF_PRESET_DIAL_COMMAND_DEC);
                Interlocked.Increment(ref _doUpdatePanelLCD);
            }
            catch (Exception ex)
            {
                        ...
                        case RadioPanelPZ69KnobsUH1H.UPPER_LARGE_FREQ_WHEEL_INC:
                            {
                                switch (_currentUpperRadioMode)
                                {
                                    ...
                                    case CurrentUH1HRadioMode.ADF:
                                        {
                                            DCSBIOS.SendAsync(ADF_TUNE_KNOB_COMMAND_INC);
                                            break;
                                        }
                                }
                                break;
                        ...
                        case RadioPanelPZ69KnobsUH1H.UPPER_SMALL_FREQ_WHEEL_INC:
                            {
                                switch (_currentUpperRadioMode)
                                {
                                    ...
                                    case CurrentUH1HRadioMode.ADF:
                                        {
                                            DCSBIOS.SendAsync(ADF_GAIN_KNOB_COMMAND_INC);
                                            break;
                                        }
                                }
                                break;
                        ...
                        case RadioPanelPZ69KnobsUH1H.UPPER_SMALL_FREQ_WHEEL_DEC:
                            {
                                switch (_currentUpperRadioMode)
                                {
                                    ...
                                    case CurrentUH1HRadioMode.ADF:
                                        {
                                            DCSBIOS.SendAsync(ADF_GAIN_KNOB_COMMAND_DEC);
                                            break;
                                        }
                                }
                                break;
